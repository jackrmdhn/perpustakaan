...
# BACA DATA DALAM FORM, masukkan datake variabel
	...
	if (count($pesanError)>=1 ){
		...
		$mySql  = "UPDATE admin SET NAMA_ADMIN='$txtNama', USERNAME='$txtUsername', LEVEL='$txtLevel'
					$passwSQL
					WHERE ID_ADMIN='$Kode'";
...
$myData = mysql_fetch_array($myQry);
	...
	$dataLevel	= isset($_POST['txtLevel']) ? $_POST['txtLevel'] : $myData['LEVEL'];
?>
...
<table width="100%" class = "table-list" border="0" cellspacing="1" cellpadding="1" bgcolor="#CCCCCC"">
  <tbody>
    <tr>
      <td colspan="3"><h2><font size="6">Edit Data Admin</h2></td>
    </tr>
        <tr>
      <td colspan="3">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td><font size="4.5">Level</td>
      <td>:</td>
      <td><input name="txtLevel" type="text"  value="<?php echo $dataLevel; ?>" size="30" maxlength="20" /></td>
    </tr>
    <tr>
